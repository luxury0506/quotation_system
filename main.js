        ...
        const allProducts = [
            ...
            { code: 'GS-10', name: '熱定型套管 10.0mm', unit: 'M', price: '', note: '100M/捲', category: 'GS' },
                ...
                { code: 'H180',   name: '通用型熱收縮套管 180.0mm', unit: 'M', price: '194.78',note: '', category: 'H' },
                 ...
                 // CB 超薄型熱收縮套管（依你提供進價）
                { code: 'H008CB',  name: '超薄熱縮套管 0.8mm',  unit: 'M', price: '1.11', note: '', category: 'HCB' },
                { code: 'H01CB',   name: '超薄熱縮套管 1.0mm',  unit: 'M', price: '1.01', note: '', category: 'HCB' },
                { code: 'H015CB',  name: '超薄熱縮套管 1.5mm',  unit: 'M', price: '1.09', note: '', category: 'HCB' },
                { code: 'H02CB',   name: '超薄熱縮套管 2.0mm',  unit: 'M', price: '1.34', note: '', category: 'HCB' },
                { code: 'H025CB',  name: '超薄熱縮套管 2.5mm',  unit: 'M', price: '0.95', note: '', category: 'HCB' },
                { code: 'H03CB',   name: '超薄熱縮套管 3.0mm',  unit: 'M', price: '1.03', note: '', category: 'HCB' },
                { code: 'H035CB',  name: '超薄熱縮套管 3.5mm',  unit: 'M', price: '1.19', note: '', category: 'HCB' },
                { code: 'H04CB',   name: '超薄熱縮套管 4.0mm',  unit: 'M', price: '1.35', note: '', category: 'HCB' },
                { code: 'H045CB',  name: '超薄熱縮套管 4.5mm',  unit: 'M', price: '1.43', note: '', category: 'HCB' },
                { code: 'H05CB',   name: '超薄熱縮套管 5.0mm',  unit: 'M', price: '1.75', note: '', category: 'HCB' },
                { code: 'H06CB',   name: '超薄熱縮套管 6.0mm',  unit: 'M', price: '1.99', note: '', category: 'HCB' },
                { code: 'H07CB',   name: '超薄熱縮套管 7.0mm',  unit: 'M', price: '2.31', note: '', category: 'HCB' },
                { code: 'H08CB',   name: '超薄熱縮套管 8.0mm',  unit: 'M', price: '2.62', note: '', category: 'HCB' },
                { code: 'H09CB',   name: '超薄熱縮套管 9.0mm',  unit: 'M', price: '2.78', note: '', category: 'HCB' },
                { code: 'H10CB',   name: '超薄熱縮套管 10.0mm', unit: 'M', price: '3.02', note: '', category: 'HCB' },
                { code: 'H11CB',   name: '超薄熱縮套管 11.0mm', unit: 'M', price: '3.34', note: '', category: 'HCB' },
                { code: 'H12CB',   name: '超薄熱縮套管 12.0mm', unit: 'M', price: '3.58', note: '', category: 'HCB' },
                { code: 'H13CB',   name: '超薄熱縮套管 13.0mm', unit: 'M', price: '4.13', note: '', category: 'HCB' },
                { code: 'H14CB',   name: '超薄熱縮套管 14.0mm', unit: 'M', price: '4.45', note: '', category: 'HCB' },
                { code: 'H15CB',   name: '超薄熱縮套管 15.0mm', unit: 'M', price: '4.85', note: '', category: 'HCB' },
                { code: 'H16CB',   name: '超薄熱縮套管 16.0mm', unit: 'M', price: '5.49', note: '', category: 'HCB' },

                // H 透明通用型熱收縮套管（使用進價作為單價）
                { code: 'H01C',   name: '透明通用型熱收縮套管 1.0mm',   unit: 'M', price: '0.86',  note: '', category: 'HC' },
                { code: 'H015C',  name: '透明通用型熱收縮套管 1.5mm',   unit: 'M', price: '0.93',  note: '', category: 'HC' },
                { code: 'H02C',   name: '透明通用型熱收縮套管 2.0mm',   unit: 'M', price: '0.86',  note: '', category: 'HC' },
                { code: 'H025C',  name: '透明通用型熱收縮套管 2.5mm',   unit: 'M', price: '1.01',  note: '', category: 'HC' },
                { code: 'H03C',   name: '透明通用型熱收縮套管 3.0mm',   unit: 'M', price: '1.09',  note: '', category: 'HC' },
                { code: 'H035C',  name: '透明通用型熱收縮套管 3.5mm',   unit: 'M', price: '1.24',  note: '', category: 'HC' },
                { code: 'H04C',   name: '透明通用型熱收縮套管 4.0mm',   unit: 'M', price: '1.40',  note: '', category: 'HC' },
                { code: 'H045C',  name: '透明通用型熱收縮套管 4.5mm',   unit: 'M', price: '1.48',  note: '', category: 'HC' },
                { code: 'H05C',   name: '透明通用型熱收縮套管 5.0mm',   unit: 'M', price: '1.79',  note: '', category: 'HC' },
                { code: 'H06C',   name: '透明通用型熱收縮套管 6.0mm',   unit: 'M', price: '2.10',  note: '', category: 'HC' },
                { code: 'H07C',   name: '透明通用型熱收縮套管 7.0mm',   unit: 'M', price: '2.41',  note: '', category: 'HC' },
                { code: 'H08C',   name: '透明通用型熱收縮套管 8.0mm',   unit: 'M', price: '2.72',  note: '', category: 'HC' },
                { code: 'H09C',   name: '透明通用型熱收縮套管 9.0mm',   unit: 'M', price: '2.88',  note: '', category: 'HC' },
                { code: 'H10C',   name: '透明通用型熱收縮套管 10.0mm',  unit: 'M', price: '3.11',  note: '', category: 'HC' },
                { code: 'H11C',   name: '透明通用型熱收縮套管 11.0mm',  unit: 'M', price: '3.42',  note: '', category: 'HC' },
                { code: 'H12C',   name: '透明通用型熱收縮套管 12.0mm',  unit: 'M', price: '3.73',  note: '', category: 'HC' },
                { code: 'H13C',   name: '透明通用型熱收縮套管 13.0mm',  unit: 'M', price: '4.35',  note: '', category: 'HC' },
                { code: 'H14C',   name: '透明通用型熱收縮套管 14.0mm',  unit: 'M', price: '4.47',  note: '', category: 'HC' },
                { code: 'H15C',   name: '透明通用型熱收縮套管 15.0mm',  unit: 'M', price: '5.05',  note: '', category: 'HC' },
                { code: 'H16C',   name: '透明通用型熱收縮套管 16.0mm',  unit: 'M', price: '5.60',  note: '', category: 'HC' },
                { code: 'H17C',   name: '透明通用型熱收縮套管 17.0mm',  unit: 'M', price: '6.38',  note: '', category: 'HC' },
                { code: 'H18C',   name: '透明通用型熱收縮套管 18.0mm',  unit: 'M', price: '7.00',  note: '', category: 'HC' },
                { code: 'H20C',   name: '透明通用型熱收縮套管 20.0mm',  unit: 'M', price: '8.24',  note: '', category: 'HC' },
                { code: 'H22C',   name: '透明通用型熱收縮套管 22.0mm',  unit: 'M', price: '9.95',  note: '', category: 'HC' },
                { code: 'H25C',   name: '透明通用型熱收縮套管 25.0mm',  unit: 'M', price: '11.04', note: '', category: 'HC' },
                { code: 'H28C',   name: '透明通用型熱收縮套管 28.0mm',  unit: 'M', price: '14.46', note: '', category: 'HC' },
                { code: 'H30C',   name: '透明通用型熱收縮套管 30.0mm',  unit: 'M', price: '14.77', note: '', category: 'HC' },
                { code: 'H35C',   name: '透明通用型熱收縮套管 35.0mm',  unit: 'M', price: '21.00', note: '', category: 'HC' },
                { code: 'H40C',   name: '透明通用型熱收縮套管 40.0mm',  unit: 'M', price: '24.26', note: '', category: 'HC' },
